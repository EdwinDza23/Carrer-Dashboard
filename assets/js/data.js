...
(function () {
  ...
  const candidateData = {
    ...
    profile: {
      ...
      website: 'edwindsouza.design',
      linkedin: 'linkedin.com/in/edwindsouza',
      bio: 'Senior UI/UX Designer with 5+ years of experience building product experiences for SaaS and fintech. Specialise in design systems, user research, and complex B2B interfaces.',
      experience: '5 years',
      ...
      experience_list: [
        { title: 'Senior UI/UX Designer', company: 'Zeta Fintech', period: '2022 – Present', desc: 'Led design for the core payments product, serving 2M+ users. Built the company design system from scratch.' },
        { title: 'UI/UX Designer', company: 'Orbit Labs', period: '2021 – 2022', desc: 'Designed onboarding and dashboard experiences for a B2B SaaS analytics platform.' },
    ...
    messages: [
      {
        id: 'msg1', name: 'Riya Kapoor', role: 'Lead Recruiter · Edwin Studio', initials: 'RK', preview: "Great news! Your application for Sr. Product Designer has moved to Shortlisting.", time: '1h ago', unread: true, thread: [
          { from: 'Riya Kapoor', out: false, text: "Hi Edwin! Great news — your application for Senior Product Designer at Acme Corp has been shortlisted. I'll be in touch with next steps soon.", time: '10:05 AM' },
          { from: 'Edwin Dsouza', out: true, text: "That's wonderful news, thank you Riya! Looking forward to hearing more.", time: '10:28 AM' },
      ...
      },
      {
        id: 'msg2', name: 'Sam Okafor', role: 'Talent Partner · Edwin Studio', initials: 'SO', preview: 'Following up on the Design Systems Lead opportunity at Acme Corp.', time: 'Yesterday', unread: false, thread: [
          { from: 'Sam Okafor', out: false, text: "Hi Edwin, following up on the Design Systems Lead role at Acme Corp. Would you be open to exploring this opportunity?", time: 'Yesterday 2:00 PM' },
          { from: 'Edwin Dsouza', out: true, text: "Hi Sam, yes absolutely! I'd love to learn more about the role.", time: 'Yesterday 4:15 PM' },
        ]
      },
    ],

    documents: [
      { id: 'd1', name: 'Edwin_Dsouza_Resume_2026.pdf', type: 'resume', size: '245 KB', uploaded: 'Jul 10, 2026', status: 'active' },
